# -- encoding: utf-8 --
# @time:    2020/12/18 0:00
# @Author: jsonLiu
# @Email: 810030709@qq.com
# @file: test_004_withdraw_method1.py
import decimal
import json
import os
import unittest
...
@ddt.ddt
class TestWithdrawMethod1(unittest.TestCase):
    EH = ExcelHandle(dev_settings.test_data_path)
    data = EH.read_all_data(yaml_data['excel']['sheet'][5])
    ...
    @ddt.data(*data)
    def test_withdraw_method1(self, test_data):
                ...
                for k,v in json.loads(test_data["expected"]).items():
                    if k in json_data:
                        ...
                        self.EH.write_back(
                            ...
                            sheet_name=yaml_data['excel']['sheet'][5],
